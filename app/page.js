...
export default function Home() {
  ...
  useEffect(() => {
    try {
      ...
      // TODO(fase-1): reemplazar por CartProvider con almacenamiento validado.
  ...
  const filteredProducts = PRODUCTS.filter((p) => {
    ...
    if (currentGender !== 'all' && p.gender !== currentGender && p.gender !== 'Unisex')
      return false;
    if (searchQuery.trim()) {
  ...
  const handleAddDozenToCart = (product) => {
    ...
    showToastMsg(
      `Docena de ${product.name} (Talla ${chosenSize}) añadida. 15% Descuento Al Mayor Aplicado.`,
      'success',
    );
    setIsCartOpen(true);
  };
    ...
    <div className="app-container">
      ...
      <div className="top-bar">
        <div className="top-bar-content">
          <span>
            MARACAY, VENEZUELA • DESCUENTO AL MAYOR: 15% OFF COMPRANDO 1 DOCENA (12 UDS) • WHATSAPP:
            +58 412-530-5464
          </span>
        </div>
      </div>
      ...
      <header className="header-sticky" id="header">
        <div className="header-container">
            ...
            <ul className="nav-menu">
              ...
              <li className="nav-dropdown">
                <a href="#catalogo" className="nav-link">
                  Tienda Online <span className="nav-arrow-icon">▼</span>
                </a>
          ...
          <div className="header-actions">
            ...
            <button
              className="action-icon-btn cart-btn-style"
      ...
      <div className={`mobile-nav-drawer ${isMobileNavOpen ? 'active' : ''}`}>
        <div className="mobile-nav-header">
          ...
          <button className="close-btn" onClick={() => setIsMobileNavOpen(false)}>
            &times;
          </button>
        </div>
        ...
        <div className="hero-main-container">
          <div className="hero-brand-card">
            ...
            <p className="hero-statement-sub">
              ...
              Ahora tenemos un nuevo método de compra a través de nuestra página web, dale un
              vistazo, conoce más sobre nosotros y mantente atento a todas nuestras nuevas
              colecciones.
            </p>
          </div>
        ...
        <div className="services-grid">
          <div className="service-card">
            ...
            <p className="service-desc">
              Servicio personalizado de orientación y asesoramiento en el ámbito del estilo.
              Recomendamos prendas y combinaciones ideales según tu personalidad, tipo de cuerpo y
              ocasión.
            </p>
            <a
              href="https://wa.me/584125305464?text=Hola!%20Quisiera%20solicitar%20una%20Asesor%C3%ADa%20de%20Moda%20en%20Kenhion%20Allen"
              target="_blank"
          ...
          <div className="service-card">
            ...
            <p className="service-desc">
              Modelo de negocio que nos permite producir productos bajo demanda cuando el cliente
              realiza el pedido, garantizando piezas exclusivas de edición limitada.
            </p>
          ...
          <div className="service-card">
            ...
            <p className="service-desc">
              Servicio creativo de vestuario a medida adaptado a tus ideas. Recomendado para
              artistas, celebridades y personas que buscan prendas verdaderamente únicas.
            </p>
            <a
              href="https://wa.me/584125305464?text=Hola!%20Me%20interesa%20el%20servicio%20de%20Prendas%20Personalizadas"
              target="_blank"
              rel="noopener noreferrer"
              className="service-link"
            >
        ...
        <div className="catalog-controls">
          <div className="filter-tabs-container">
            <div className="filter-tabs">
              ...
              <button
                className={`filter-btn ${currentCategory === 'KA ELITE' ? 'active' : ''}`}
                onClick={() => setCurrentCategory('KA ELITE')}
              >
                <span>KA ELITE</span>
                <span className="count-pill">{countElite}</span>
              </button>
              <button
                className={`filter-btn ${currentCategory === 'Resiliencia' ? 'active' : ''}`}
                onClick={() => setCurrentCategory('Resiliencia')}
              >
                <span>Resiliencia</span>
                <span className="count-pill">{countResiliencia}</span>
              </button>
              <button
                className={`filter-btn ${currentCategory === 'P.O.D.' ? 'active' : ''}`}
                onClick={() => setCurrentCategory('P.O.D.')}
              >
                <span>P.O.D.</span>
            ...
            <div className="gender-filter-pills">
              ...
              <button
                className={`gender-pill ${currentGender === 'all' ? 'active' : ''}`}
                onClick={() => setCurrentGender('all')}
              >
                Todos
              </button>
              <button
                className={`gender-pill ${currentGender === 'Mujer' ? 'active' : ''}`}
                onClick={() => setCurrentGender('Mujer')}
              >
                Mujer
              </button>
              <button
                className={`gender-pill ${currentGender === 'Hombre' ? 'active' : ''}`}
                onClick={() => setCurrentGender('Hombre')}
              >
                Hombre
              </button>
              <button
                className={`gender-pill ${currentGender === 'Unisex' ? 'active' : ''}`}
                onClick={() => setCurrentGender('Unisex')}
              >
                Unisex
              </button>
              ...
              <button className="size-guide-trigger-btn" onClick={() => setIsSizeGuideOpen(true)}>
                <svg
                  ...
                  strokeWidth="2"
                >
                  <path d="M2 12h20M6 8v8M10 9v6M14 8v8M18 9v6"></path>
                </svg>
              ...
              return (
                <div key={product.id} className="product-card">
                  <div className="product-img-box" onClick={() => handleOpenProductModal(product)}>
                    ...
                    />
                    <span className={`product-badge-pill ${product.badgeType}`}>
                      {product.badge}
                    </span>
                    <button
                  ...
                  <div className="product-info">
                    ...
                    <div className="card-actions-group">
                      ...
                      <button
                        className="add-dozen-card-btn"
                        onClick={() => handleAddDozenToCart(product)}
                        title="Pedir 12 Unidades con 15% Descuento Al Mayor"
                      >
      ...
      <section className="gallery-section" id="galeria">
        <div className="section-header center">
          ...
          <p className="section-subtext">
            Haz clic en cualquier imagen para verla en vista detallada.
          </p>
        </div>
        ...
        <div className="gallery-grid">
          {[
            {
              src: 'https://af606c0c04.cbaul-cdnwnd.com/a50e9269c7b3dca260132ece6590c58c/200000110-2b9d22b9d4/IMG_0964.JPG-5.jpeg?ph=af606c0c04',
              title: 'Colección Kenhion Allen 1',
            },
            {
              src: 'https://af606c0c04.cbaul-cdnwnd.com/a50e9269c7b3dca260132ece6590c58c/200000085-22e1522e17/IMG_0977.JPG.jpeg?ph=af606c0c04',
              title: 'Colección Kenhion Allen 2',
            },
            {
              src: 'https://af606c0c04.cbaul-cdnwnd.com/a50e9269c7b3dca260132ece6590c58c/200000094-0c01b0c01c/IMG_0976.JPG.jpeg?ph=af606c0c04',
              title: 'Colección Kenhion Allen 3',
            },
            {
              src: 'https://af606c0c04.cbaul-cdnwnd.com/a50e9269c7b3dca260132ece6590c58c/200000088-913299132b/IMG_0979.JPG.jpeg?ph=af606c0c04',
              title: 'Colección Kenhion Allen 4',
            },
          ].map((item, idx) => (
            <div
              key={idx}
              className="gallery-item"
              onClick={() => setLightbox({ isOpen: true, src: item.src, caption: item.title })}
            >
          ...
          <div className="about-text-content">
            ...
            <div className="about-features-grid">
              <div className="feature-box">
                <div className="feature-icon-svg">
                  <svg
                    ...
                    strokeWidth="1.75"
                  >
                    <path d="M12 2l2.4 5.6L20 10l-4.4 4.4L16.8 20 12 17l-4.8 3 1.2-5.6L4 10l5.6-2.4L12 2z"></path>
                  </svg>
                </div>
              ...
              <div className="feature-box">
                ...
                <p>
                  Materiales duraderos, 100% algodón de alto gramaje y fibras sintéticas técnicas.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="faq-section" id="faq">
        <div className="section-header center">
          ...
          <p className="section-subtext">
            Información sobre envíos en Venezuela, compras al mayor por docenas y atención
            personalizada.
          </p>
        </div>
        ...
        <div className="contact-card-box">
            ...
            <div className="contact-details-list">
              ...
              <div className="contact-detail-item">
                ...
                <div>
                  ...
                  <p>
                    <a href="https://wa.me/584125305464" target="_blank" rel="noopener noreferrer">
                      +58 412-530-5464
                    </a>
                  </p>
                </div>
          ...
          <div className="contact-action-col">
            <div className="direct-chat-card">
              ...
              <p>
                ¿Tienes dudas sobre tallas, disponibilidad o pedidos al mayor por docena en
                Venezuela? Escríbenos directamente:
              </p>

              <a
                href="https://wa.me/584125305464?text=Hola%20Kenhion%20Allen,%20un%20gusto%20saludarlos!%20Quisiera%20realizar%20una%20consulta"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="footer-content">
          <div className="footer-brand-col">
            ...
            <p className="footer-brand-desc">
              Tienda de ropa especializada en prendas elegantes para hombres y mujeres. Ofrecemos
              ropa de diseñador con un estilo elegante y conservador.
            </p>
      ...
      <div className={`modal-overlay ${isSizeGuideOpen ? 'active' : ''}`}>
        <div className="modal-card size-guide-card">
          <button className="modal-close" onClick={() => setIsSizeGuideOpen(false)}>
            &times;
          </button>
          <div className="size-guide-header">
            ...
            <p className="modal-desc">
              Utiliza esta tabla para seleccionar la talla perfecta para prendas de compresión KA
              ELITE o 100% Algodón Resiliencia.
            </p>
          </div>
          ...
          <div className="size-guide-footer-tips">
            <div className="tip-box">
              <strong>KA ELITE (Compresión):</strong> Tienen ajuste ceñido. Si prefieres un ajuste
              más relajado, elige una talla superior.
            </div>
            <div className="tip-box">
              <strong>Resiliencia (Algodón 100%):</strong> Presentan un patrón Oversize holgado con
              caída estructurada de diseñador.
            </div>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        onClick={(e) => {
          if (e.target.classList.contains('cart-drawer-overlay')) setIsCartOpen(false);
        }}
      >
            ...
            {cart.length === 0 ? (
              <div className="cart-empty-msg">
                ...
                <span style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
                  Explora las colecciones Kenhion Allen y elige tus prendas y tallas.
                </span>
              </div>
            ) : (
              cart.map((item, idx) => (
                  ...
                  <div className="cart-item-details">
                    ...
                    <div className="cart-item-size-row">
                      ...
                      <select
                        ...
                        value={item.size}
                        onChange={(e) => handleUpdateCartSize(idx, e.target.value)}
                      >
                    ...
                    <div className="cart-item-controls">
                      <div className="qty-control">
                        <button className="qty-btn-sm" onClick={() => handleUpdateQty(idx, -1)}>
                          -
                        </button>
                      ...
                      <span className="cart-item-remove" onClick={() => handleRemoveItem(idx)}>
                        Eliminar
                      </span>
                    </div>
                  </div>
              ...
              <div className={`wholesale-banner ${isWholesale ? 'active-discount' : 'tip'}`}>
                {isWholesale ? (
                  <>
                    ...
                    <span>
                      ¡Docena completada! Se ha aplicado un{' '}
                      <strong>15% de descuento al mayor</strong> en tu pedido.
                    </span>
                  </>
                ) : (
                  <span>
                    <strong>Tip al mayor:</strong> Añade{' '}
                    <strong>
                      {12 - totalCartQty} prenda{12 - totalCartQty > 1 ? 's' : ''} más
                    </strong>{' '}
                    (1 docena) y obtén <strong>15% Descuento Al Mayor</strong>.
                  </span>
                )}
              </div>
              ...
              <div className="cart-summary-breakdown">
                ...
                {isWholesale && (
                  <div className="cart-summary-row discount-row">
                    <span className="summary-label text-green">
                      Descuento Al Mayor (15% Docena):
                    </span>
                    <span className="summary-val text-green">
                      -${wholesaleDiscount.toFixed(2)} USD
                    </span>
                  </div>
                )}
      ...
      {selectedProduct && (
        <div
          ...
          onClick={(e) => {
            if (e.target.classList.contains('modal-overlay')) setSelectedProduct(null);
          }}
        >
            ...
            <div className="modal-grid">
              <div className="modal-img-box">
                <img
                  ...
                  onError={(e) => {
                    e.target.src = selectedProduct.fallbackImage;
                  }}
              ...
              <div className="modal-body">
                ...
                <div className="modal-price-row">
                  ...
                  {selectedProduct.oldPrice && (
                    <span className="modal-old-price">${selectedProduct.oldPrice.toFixed(2)}</span>
                  )}
                </div>
                ...
                <div className="modal-option-group">
                  <div className="size-label-row">
                    ...
                    <button
                      className="modal-size-guide-btn"
                      onClick={() => {
                        setSelectedProduct(null);
                        setIsSizeGuideOpen(true);
                      }}
                    >
                      Ver Guía de Tallas (cm)
                    </button>
                  </div>
                ...
                <div className="modal-option-group">
                  ...
                  <div className="quantity-picker">
                    <button
                      className="qty-btn"
                      onClick={() => {
                        if (modalQty > 1) setModalQty(modalQty - 1);
                      }}
                    >
                      -
                    </button>
                    <span className="qty-val">{modalQty}</span>
                    <button className="qty-btn" onClick={() => setModalQty(modalQty + 1)}>
                      +
                    </button>
                  </div>
                </div>
                ...
                <div className="modal-actions-wrapper">
                  <button
                    className="btn-primary-black add-to-cart-action"
                    onClick={() => {
                      addItemToCart(selectedProduct, modalSize, modalQty);
                      setSelectedProduct(null);
                    }}
                  >
                    <svg
                  ...
                  <button
                    className="btn-wholesale-dozen"
                    onClick={() => {
                      handleAddDozenToCart(selectedProduct);
                      setSelectedProduct(null);
                    }}
                  >
      ...
      <div
        ...
        onClick={(e) => {
          if (e.target.classList.contains('search-overlay')) setIsSearchOpen(false);
        }}
      >
            ...
            {!quickSearchInput.trim() ? (
              ...
              PRODUCTS.filter(
                (p) =>
                  ...
                  p.category.toLowerCase().includes(quickSearchInput.toLowerCase()),
              ).map((p) => (
                <div
                  key={p.id}
